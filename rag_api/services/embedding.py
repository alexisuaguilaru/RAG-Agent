...
def embed_content(content_blocks: List[Dict[str, Any]]):
    ...
    for batch in range(num_batches):
        ...
        try:
            embeddings_ids = _generate_embeddings(content_inputs)
...
def _generate_embeddings(content_inputs: List[Dict[str, Any]]):
    try:
    ...
    try:
        embeddings_ids = vector_store.add_texts(formatted_inputs)
    except Exception as e:
        raise e
